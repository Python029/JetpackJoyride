...
namespace JetpackJoyride
{
    public partial class Form1 : Form
    {
        ...
        private void Death()
        {
            ...
            else if (ground == false && deadbounce == false && deadslide == false)
            {
                Gravity();
            }
        ...
        private void Form1_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            if(e.KeyCode ==Keys.Escape)
            {
                ...
                tmrScore.Enabled = false;
                tmrUpdate.Enabled = false;
                DialogResult dialogResult = MessageBox.Show("Are you sure you want to quit?","Quit Game",MessageBoxButtons.YesNo,MessageBoxIcon.Warning);
                if(dialogResult == DialogResult.Yes)
                {
                    Application.Exit();
                }
        ...
        {
            if(start == false&& go == false) { MessageBox.Show("Use Space, Up Arrow, or W to fly.", "Controls", MessageBoxButtons.OK, MessageBoxIcon.Information); }  
        }
    }
}
